...
- [x] 3.3 Map invalid JSON, media type, request fields, expression failures, and limit failures to the documented public error envelope, and verify endpoint tests assert status codes and machine-readable error codes.
...
- [x] 4.2 Publish OpenAPI-visible request, success, and error examples for `/health` and `/roll`, and verify generated API documentation reflects the specified contract.
